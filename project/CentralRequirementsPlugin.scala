...
object CentralRequirementsPlugin extends AutoPlugin {
  ...
  override lazy val projectSettings = Seq(
    ...
    homepage := Some(url("http://getnelson.github.io/lighthouse/")),
    scmInfo := Some(ScmInfo(url("https://github.com/getnelson/lighthouse"),
                                "git@github.com:getnelson/lighthouse.git"))
  )
}